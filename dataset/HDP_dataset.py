...
class HDPTrainDataset(HDPDataset):
    def __init__(
        self,
        dataset_dir=dataset_dir,
        config={}
...
def get_hdp_datasets(dataset_dir=dataset_dir, config={}, verbose=False):
    datasets = HDPDataset(dataset_dir, config)
